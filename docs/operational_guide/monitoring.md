...
m3db is integrated with [opentracing](https://opentracing.io/)
to provide insight into query performance and errors.
...
Note: all URLs assume a local jaeger setup as describe in Jaeger's
